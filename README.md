# Sara Rigatti and Nicole Francis (2026)
Final Project: Quantifying Hurricane Storm Surges and their Impacts in Grand Isle, LA, USA

EESC 4464/6664: Environmental Data Exploration and Analysis, Spring 2026

### Hurricane Water Level Analysis in Grand Isle, LA
This reposity contains the necessary analysis materials for our final project analysis of water level anomaly associated with hurricanes between 2014-2024 within 60 nautical miles of Grand Isle, LA. Code is included for correcting the time stamps from the original dataset, calculating the water level anomaly, finding strength, distance, and intensity ratings for each storm, and generating corresponding figures. 
